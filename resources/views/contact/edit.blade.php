            ...
            <div class="row">
                ...
                <div id="more_div" class="hide">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="added-div" style="display: flex; flex-wrap: wrap; align-items: center; width: 100%; gap: 10px;">

                                <div class="mb-4" style="flex-basis: 100%; display: flex; flex-direction: column; gap: 10px; align-items: center; max-width: 350px; margin: auto; padding: 15px; background: #f9f9f9; border-radius: 10px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
                                    <label for="client_image" class="block text-sm font-medium text-gray-700" style="font-weight: bold; color: #333; text-align: center; font-size: 16px;">Upload Client Image</label>
                                    <input type="file" name="client_image" id="client_image" accept="image/*"
                                        ...
                                        style="padding: 10px; border-radius: 8px; border: 2px dashed #CBD5E0; box-shadow: 3px 3px 8px rgba(0,0,0,0.1); width: 100%; text-align: center; background: #fff;">
                                    @error('client_image')
                                    <p class="text-red-500 text-xs mt-1" style="color: #E53E3E; font-size: 13px; margin-top: 5px; text-align: center; font-weight: bold;">{{ $message }}</p>
                                    @enderror
                                </div>
                            </div>
